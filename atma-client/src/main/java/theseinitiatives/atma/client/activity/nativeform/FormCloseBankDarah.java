...
public class FormCloseBankDarah extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.form_tutup_bank_darah);
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dbManager.open();
                dbManager.closeBankDarah(idIbu,status_,alasan);
                dbManager.insertsyncTable(DbHelper.TABLE_CLOSE_BANK_DARAH, System.currentTimeMillis(),textDusun, dataArray.toString(), 0, 0);
                ...
                finish();
                Intent myIntent = new Intent(FormCloseBankDarah.this, BankDarahActivity.class);
        ...
        switch (view.getId()) {
            ...
            case R.id.tutup_ya:
                if (checked)
                    setStatuss("ya");
                break;
            case R.id.tidak_bisa_donor:
                if(checked)
                    setAlasan("tidak bisa donor");
                break;
            case R.id.meninggal:
                if(checked)
                    setAlasan("meninggal");
